                         ...
                         <div class="card-body">
                             ...
                             <form method="post" action="{{ route('store.portfolio') }}" enctype="multipart/form-data">
                                 ...
                                 <div class="row mb-3">
                                     ...
                                     <div class="col-sm-10">
                                         <input class="form-control" type="text" value="{{ $portfolio->portfolio_name }}"
                                             name="portfolio_name" id="portfolio_name">
                                 ...
                                 <div class="row mb-3">
                                     ...
                                     <div class="col-sm-10">
                                         <input class="form-control" type="text"
                                             value="{{ $portfolio->portfolio_tittle }} name="portfolio_tittle"
                                             id="portfolio_tittle">
